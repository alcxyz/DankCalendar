...
| ADR | Title | Area |
|---|---|---|
| [ADR-001](ADR-001-single-go-binary.md) | Single Go binary replaces Go+Python stack | architecture |
| [ADR-002](ADR-002-stdlib-only.md) | Stdlib-only Go, no external dependencies | dependencies |
